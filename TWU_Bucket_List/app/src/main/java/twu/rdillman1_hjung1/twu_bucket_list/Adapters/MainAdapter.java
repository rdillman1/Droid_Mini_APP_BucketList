package twu.rdillman1_hjung1.twu_bucket_list.Adapters;
...
import twu.rdillman1_hjung1.twu_bucket_list.AddNewTask;
import twu.rdillman1_hjung1.twu_bucket_list.MainActivity;
import twu.rdillman1_hjung1.twu_bucket_list.R;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    public MainAdapter(DatabaseHandler db, MainActivity activity) {
        this.db = db;
